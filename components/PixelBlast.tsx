...
// Sourced from React Bits (reactbits.dev/backgrounds/pixel-blast) — three.js +
// postprocessing based. Same pattern used before elsewhere in this repo (see
// FaultyTerminal.tsx): heavy WebGL lib, dynamically imported with ssr:false.
